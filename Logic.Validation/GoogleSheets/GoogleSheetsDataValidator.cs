...
namespace FFRKApi.Logic.Validation.GoogleSheets
{
    ...
    public class GoogleSheetsDataValidator : IGoogleSheetsDataValidator
    {
        ...
        public bool ValidateWorksheetMetadata(ImporterOptions importerOptions)
        {
            ...
            Sheet sheet = Enumerable.FirstOrDefault<Sheet>(_spreadsheet.Sheets, w => w.Properties.Title == sanitizedWorksheetName);
